...
class myClass:
    ...
    def run(self, nodes, matrix_coordinate):
        ...
        results = pool.map(self.multiprocess_matrix_comparisons, matrix_coordinates)
        return results
...
if __name__ == '__main__':
    ...
    numpy.savetxt('../../datasets/intermediate/gene_candidate/distance_matrix.txt', distance_matrix)
    print('INFO: Dumping weight matrix to disk.')
    numpy.save('../../datasets/intermediate/gene_candidate/weight_matrix.npy', weight_matrix)
    numpy.savetxt('../../datasets/intermediate/gene_candidate/weight_matrix.txt', weight_matrix)
